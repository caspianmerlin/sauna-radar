use macroquad::{prelude::Color, shapes::draw_line, window};

use super::{
    DEFAULT_AIRWAY_HIGH_COLOUR, DEFAULT_AIRWAY_LOW_COLOUR, DEFAULT_ARTCC_COLOUR,
    DEFAULT_ARTCC_HIGH_COLOUR, DEFAULT_ARTCC_LOW_COLOUR, DEFAULT_FIX_COLOUR, DEFAULT_GEO_COLOUR,
    DEFAULT_SID_COLOUR, DEFAULT_STAR_COLOUR,
};
